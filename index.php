                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title">Book Train Tickets</h1>

                            <p class="main-heading-text">Book train tickets from anywhere using the robust 
                                                        ticketing platform exclusively built to provide the 
                                                        passengers with pleasant ticketing experience.</p>
